    pipeline {
        ...
        environment {
            DOCKER_IMAGE = "xalien073/assignmentor:${env.BUILD_ID}" // Tag image with Jenkins Build ID
        }
            ...
            stage('Static Code Analysis') {
                ...
                steps {
                    withCredentials([string(credentialsId: 'sonarqube', variable: 'SONAR_AUTH_TOKEN')]) {
                        ...
                        sh """
                            apk update
                            apk add openjdk11 curl unzip nodejs npm git
                            ...
                            npm install
                            sonar-scanner \
                            -Dsonar.projectKey=assignmentor \
                            -Dsonar.sources=. \
